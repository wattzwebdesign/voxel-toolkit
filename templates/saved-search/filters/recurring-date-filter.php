<script type="text/html" id="vt-saved-search-recurring-date-filter">
...
<div class="ts-form-group">
    ...
    <div class="ts-saved-search-filter" :class="{'ts-filled': filter.value !== null}">
        <div class="ts-saved-search-filter-text">{{ filter.preset ? filter.preset.label : filter.value }}</div>
    </div>
</div>
</script>
