...
class Voxel_Toolkit_Link_Management {
    ...
    public function enqueue_scripts() {
        ...
        $custom_css = ':root {
            --vt-lm-modal-bg: ' . esc_attr($colors['modal_bg']) . ';
            --vt-lm-title-color: ' . esc_attr($colors['title_color']) . ';
            --vt-lm-message-color: ' . esc_attr($colors['message_color']) . ';
            --vt-lm-icon-bg: ' . esc_attr($colors['icon_bg']) . ';
            --vt-lm-icon-color: ' . esc_attr($colors['icon_color']) . ';
            --vt-lm-continue-bg: ' . esc_attr($colors['continue_bg']) . ';
            --vt-lm-continue-text: ' . esc_attr($colors['continue_text_color']) . ';
            --vt-lm-cancel-bg: ' . esc_attr($colors['cancel_bg']) . ';
            --vt-lm-cancel-text: ' . esc_attr($colors['cancel_text_color']) . ';
        }';
